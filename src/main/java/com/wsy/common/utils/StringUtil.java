...
public class StringUtil {
	...
	//随机出一个中文汉字
	public static String randomChines()
	{
		String str=null;
		int hisPos=0;
		int lowPos=0;
		Random random=new Random();
		hisPos=(176+Math.abs(random.nextInt(39)));
		random=new Random();
		lowPos=(161+Math.abs(random.nextInt(93)));
		byte[ ] bArr=new byte[2];
		bArr[0]=(new Integer(hisPos).byteValue());
	...
	//TODO 实现代码
		...
		String name1=randomChineseString(RandomUtil.random(1, 2));
		return name+name1;
